# docker-stress-ng
[![Docker Automated build](https://img.shields.io/docker/automated/wdhif/stress-ng.svg)]() [![Docker Build Status](https://img.shields.io/docker/build/wdhif/stress-ng.svg)]()  
Docker container for stress-ng

## Usage
```
$ docker run --rm -it wdhif/stress-ng --cpu 8 --io 4 --vm 2 --vm-bytes 128M --fork 4 --timeout 10s
```
